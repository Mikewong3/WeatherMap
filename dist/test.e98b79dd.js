...
var targetElement = document.getElementById("mapContainer"); // Get default map types from the platform object:

var defaultLayers = platform.createDefaultLayers(); // Instantiate the map:
...
var onResult = function onResult(result) {
  var locations = result.Response.View[0].Result,
      position,
      marker; // Add a marker for each location found
  ...
  for (i = 0; i < locations.length; i++) {
    ...
    console.log(locations[i].Location.DisplayPosition.Latitude);
    console.log(locations[i].Location.DisplayPosition.Longitude);
